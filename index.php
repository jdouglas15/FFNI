                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">About Fish Finder NI</h6>
                            </div>
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                        src="img/undraw_fishing_hoxa.svg" alt="...">
                                </div>
                                <p>Promoting Northern Ireland's Fly Fishing Locations | <hr>
                                    We believe that NI's fly fishing scene is undervalued, we want to change that! Browse this website to find fly fishing locations all over Northern Ireland. If you wish to add a new lake, river, or club stretch, just fill in the form <a href="#">here</a> and it will be processed and added to the website. </p>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">The Basics</h6>
                            </div>
                            <div class="card-body">
                                <p>To fish legally in Northern Ireland you need to:</p>
